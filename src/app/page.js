...
export default function RestaurantWebsite() {
  ...
  // Get first letter of username for profile image
  ...
  const testimonials = [
    {
      quote:
        "The restaurant offers an exceptional dining experience with a warm ambiance, impeccable service, and deliciously presented food.",
      name: "Karma",
      role: "Teacher",
      img: "https://pics.craiyon.com/2023-07-16/e21ab610bd834969a43a19c7c303d437.webp",
    },
    {
      quote:
        "The restaurant provides a delightful culinary experience with a cozy ambiance, friendly staff, and flavorful dishes.",
      name: "Damber",
      role: "Engineer",
      img: "https://i1.rgstatic.net/ii/profile.image/11431281171647789-1688309468736_Q512/Sheng-Xu-55.jpg",
    },
    {
      quote:
        "With its inviting atmosphere and outstanding service, this restaurant ensures a memorable dining experience.",
      name: "Choden",
      role: "TikToker",
      img: "https://cdn.pixabay.com/photo/2017/08/04/22/36/sorrow-2581703_640.jpg",
    },
  ];
    ...
    <>
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            <a className="flex items-center" href="#">
              ...
              <span className="text-yellow-500 font-bold ml-2 text-lg">Lama Restaurant</span>
            </a>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a href="#" className="text-white font-bold hover:text-blue-300 transition">Home</a>
              <a href="#about" className="text-white font-bold hover:text-blue-300 transition">About</a>
              <a href="#service" className="text-white font-bold hover:text-blue-300 transition">Service</a>
              <a href="#menu" className="text-white font-bold hover:text-blue-300 transition">Menu</a>
              <a href="#contact" className="text-white font-bold hover:text-blue-300 transition">Contact</a>
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-3 flex flex-col space-y-3 animate-slide-down">
              <a href="#" className="text-white font-bold hover:text-blue-300 transition">Home</a>
              <a href="#about" className="text-white font-bold hover:text-blue-300 transition">About</a>
              <a href="#service" className="text-white font-bold hover:text-blue-300 transition">Service</a>
              <a href="#menu" className="text-white font-bold hover:text-blue-300 transition">Menu</a>
              ...
              <Link
                href="/login#login"
                className="text-white font-bold px-4 py-2 border border-white rounded text-center transition-transform duration-300 ease-in-out hover:text-blue-300 hover:border-blue-300 hover:scale-105 active:scale-95"
              >
                Login
              </Link>
              <a
                href="#book"
                className="bg-yellow-500 text-black font-bold px-4 py-2 rounded text-center hover:bg-yellow-600 transition duration-300"
              >
                Book Now
              </a>
            </div>
        ...
        <div className="container mx-auto px-4 text-center md:text-left relative z-10">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <a href="#book" className="inline-block bg-yellow-500 text-black font-bold px-6 py-3 rounded hover:bg-yellow-600 transition duration-300">Book a Table</a>
            </div>
      ...
      <section id="testimonials" className="container mx-auto px-4 my-12">
        <h2 className="text-center text-3xl font-bold">
          <span className="text-yellow-500">Our Clients Say!!!</span><br />
        </h2>
              ...
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 px-4">
                  <div className="bg-gray-600 rounded-lg p-5 text-center shadow-lg max-w-md mx-auto my-4">
                    <p><span className="text-3xl text-yellow-500">❝</span>{testimonial.quote}</p>
          ...
          <div className="flex justify-center mt-4 space-x-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full ${index === activeTestimonial ? 'bg-blue-500' : 'bg-gray-800'}`}
              ></button>
            ))}
          </div>
        </div>
      ...
      <section id="book" className="flex flex-col lg:flex-row items-center justify-between bg-gray-900 text-gray-100 p-8 lg:p-16">
        ...
        <div className="w-full lg:w-1/2 bg-gray-900 p-8 lg:p-10 rounded-lg">
          ...
          <h3 className="text-2xl font-bold mb-6">Book Online</h3>
  ...
  <div className="text-center p-6">
    <p className="text-gray-700 dark:text-gray-300 mb-4">You need to be logged in to make a reservation.</p>
    <button
      onClick={() => router.push("/login")}
      className="bg-yellow-500 text-black font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-yellow-600 transition duration-300"
    >
      Go to Login
    </button>
  </div>
                ...
                <form onSubmit={(e) => handleFormSubmit(e, true)}>
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-gray-100 ${
                        formErrors.date ? "border-red-500 dark:border-red-400" : ""
                      }`}
                    />
                    {formErrors.date && (
                      <p className="text-red-500 dark:text-red-400 text-sm mt-2">
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      placeholder="17:30"
                      className={`w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:text-gray-100 ${
                        formErrors.time ? "border-red-500 dark:border-red-400" : ""
                      }`}
                    />
                    {formErrors.time && (
                      <p className="text-red-500 dark:text-red-400 text-sm mt-2">
